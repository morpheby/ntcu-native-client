...
class Observable<T: AnyObject> {
    ...
    func append(_ caller: @escaping ObservationCaller) {
...
func observe<A: AnyObject, B: AnyObject> (_ observable: Observable<B>, observer: A, fire: @escaping (A, B?) -> ()) {
...
func >><A: AnyObject, B: AnyObject> (observer: A, fire: @escaping (A, B?) -> ()) -> _TmpObservationOperatorStruct<A, B> {
